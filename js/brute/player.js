...
function Player(sprites, initialX, initialY, startDirection) {
    ...
    this.walkingToEnemy = function (callback) {
    	this.spriteStep = 0;
    ...
    this.attacking = function (callback) {
    	this.spriteStep = 0;
    ...
    this.walkingHome = function (callback) {
    	this.spriteStep = 0;
    	this.currentSprite = this.sprites.Walk;
	...
	this.updateSpriteStep = function () {
