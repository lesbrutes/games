...
class Cauldrons {
	constructor() {
		this.eyecauldron = new Spell(1,1,  new CauldronSprite(0.22,30,"../image/brute/cauldron/eyecauldron.png"));
		this.lovecauldron = new Spell(2,1,  new CauldronSprite(0.3,0,"../image/brute/cauldron/lovecauldron.png"));
		this.manacauldron = new Spell(3,1,  new CauldronSprite(0.3,0,"../image/brute/cauldron/manacauldron.png"));
		this.poisoncauldron = new Spell(4,1,  new CauldronSprite(0.3,0,"../image/brute/cauldron/poisoncauldron.png"));
	}
